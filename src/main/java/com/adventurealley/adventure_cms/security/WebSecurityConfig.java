...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()// Vi vil gerne autoiserer hvilke http requests som må finde sted i hele programmet. Hvornår må programmet køre som "normalt"
                .antMatchers("/resources/**", "/static/**", "/css/**", "/images/**", "/activityPage/**", "/").permitAll() // Alle disse er tilladt når du ikke er logget ind eller er. når du er logget ind er alt ok.
